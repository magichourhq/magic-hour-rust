...
impl std::fmt::Display for V1ImageToVideoCreateBodyModelEnum {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let str_val = match self {
            ...
            V1ImageToVideoCreateBodyModelEnum::Kling26 => "kling-2.6",
            ...
            V1ImageToVideoCreateBodyModelEnum::Seedance25 => "seedance-2.5",
            ...
            V1ImageToVideoCreateBodyModelEnum::Wan30 => "wan-3.0",
        };
        write!(f, "{}", str_val)
    }
}
