...
pub struct PostV1AnimationBodyStyle {
    /// The art style of the final output video
    pub art_style: crate::models::PostV1AnimationBodyStyleArtStyleEnum,
    /// Describe custom art style. This field is required if `art_style` is `Custom`
    #[serde(skip_serializing_if = "Option::is_none")]
    pub art_style_custom: Option<String>,
    pub camera_effect: crate::models::PostV1AnimationBodyStyleCameraEffectEnum,
    ...
    pub prompt_type: crate::models::PostV1AnimationBodyStylePromptTypeEnum,
