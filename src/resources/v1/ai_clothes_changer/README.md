...
| `└─ garment_type`      |    ✗     | Type of garment to swap. If not provided, swaps the entire outfit. * `upper_body` - for shirts/jackets * `lower_body` - for pants/skirts * `dresses` - for entire outfit (deprecated, use `entire_outfit` instead) * `entire_outfit` - for entire outfit                                                                                                 | `V1AiClothesChangerCreateBodyAssetsGarmentTypeEnum::EntireOutfit`                                                                                                                                                                              |
