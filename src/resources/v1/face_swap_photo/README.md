...
| `└─ face_swap_mode`   |    ✗     | Choose how to swap faces: **all-faces** (recommended) — swap all detected faces using one source image (`source_file_path` required) +- **individual-faces** — specify exact mappings using `face_mappings`                                                                                                                                                                                                                                 | `V1FaceSwapPhotoCreateBodyAssetsFaceSwapModeEnum::AllFaces`                                                                                                                                                                                                                                                                                                                                                                |
...
| `name`                |    ✗     | Give your image a custom name for easy identification.                                                                                                                                                                                                                                                                                                                                                                                      | `"My Face Swap image".to_string()`                                                                                                                                                                                                                                                                                                                                                                                         |
...
```rust
V1FaceSwapPhotoCreateResponse {credits_charged: 10, frame_cost: 123, id: "cuid-example".to_string()}
```
