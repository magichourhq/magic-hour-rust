#[derive(Debug)]
pub struct AudioToVideoClient<'a> {
    base_client: &'a mut crate::core::base_client::BaseClient,
}
impl<'a> AudioToVideoClient<'a> {
    pub(crate) fn _new(
        base_client: &'a mut crate::core::base_client::BaseClient,
    ) -> Self {
        Self { base_client }
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::V1AudioToVideoCreateResponse> {
        let url = self.base_client.build_url("/v1/audio-to-video", None);
        let mut builder = reqwest::Client::default().post(&url);
        builder = builder.header("x-sideko-sdk-language", "rust");
        builder = builder.header("content-type", "application/json");
        builder = builder
            .json(
                &crate::models::V1AudioToVideoCreateBody {
                    name: request.name,
        ...
        crate::core::response::process_json::<
            crate::models::V1AudioToVideoCreateResponse,
        >(response)
            .await
    }
}
