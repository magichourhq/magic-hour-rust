...
| `name`                          |    ✗     | Give your image a custom name for easy identification.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `"My Background Remover image".to_string()`                                                                                                                                |
...
```rust
V1ImageBackgroundRemoverCreateResponse {credits_charged: 5, frame_cost: 123, id: "cuid-example".to_string()}
```
