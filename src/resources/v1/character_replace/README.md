...
| `└─ points`          |    ✗     | On-frame markers for manual subject selection. Required when `selection_mode` is `point`. Ignored when `selection_mode` is `auto` or omitted.                                                                                                                                                                                                                                                        | `vec![V1CharacterReplaceCreateBodyStylePointsItem {position_x: 320, position_y: 180, time_seconds: 2.5}]`                                                                                                  |
| `└─ selection_mode`  |    ✗     | How to locate the subject in the source video. `auto` detects a person automatically. `point` uses your `points` to mark the subject. Defaults to `auto`.                                                                                                                                                                                                                                            | `V1CharacterReplaceCreateBodyStyleSelectionModeEnum::Auto`                                                                                                                                                 |
