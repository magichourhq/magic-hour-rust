...
let res = client
    ...
    .create(magic_hour::resources::v1::image_to_video::CreateRequest {
        ...
        end_seconds: 5.0,
        model: Some(magic_hour::models::V1ImageToVideoCreateBodyModelEnum::Sora2),
