...
| `name`               |    ✗     | Give your image a custom name for easy identification.                                                                                                                                                                                                                                                                                                                                                              | `"My Ai Headshot image".to_string()`                                                            |
...
```rust
V1AiHeadshotGeneratorCreateResponse {credits_charged: 50, frame_cost: 123, id: "cuid-example".to_string()}
```
